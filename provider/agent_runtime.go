...
// v28 only reorganizes modules; v27 already implements these workspace features.
func supportsWorkspaceRecovery(version string) bool {
	return isCurrentAgentProtocolVersion(version) || strings.TrimSpace(version) == "lcmd-webshell-agent-v27"
}

func isAttachCompatibleAgentProtocolVersion(version string) bool {
	switch strings.TrimSpace(version) {
	case AgentProtocolVersion, "lcmd-webshell-agent-v27", "lcmd-webshell-agent-v26", "lcmd-webshell-agent-v25", "lcmd-webshell-agent-v24", "lcmd-webshell-agent-v23", "lcmd-webshell-agent-v22", "lcmd-webshell-agent-v21", "lcmd-webshell-agent-v20", "lcmd-webshell-agent-v19", "lcmd-webshell-agent-v18", "lcmd-webshell-agent-v17", "lcmd-webshell-agent-v16", "lcmd-webshell-agent-v15", "lcmd-webshell-agent-v14", "lcmd-webshell-agent-v13", "lcmd-webshell-agent-v12", "lcmd-webshell-agent-v11", "lcmd-webshell-agent-v10", "lcmd-webshell-agent-v9":
		return true
	default:
		return false
	}
...
func persistentAgentAttachCommandArgs(scope AgentScope, paneID string, cols, rows, terminalScrollback int, syncRequest HistorySyncRequest) []string {
	...
	if syncRequest.CheckpointProtocol == TerminalMemoryCheckpointProtocol {
		// v28 shares the v27/v26 WASM. Earlier agents remain wire-compatible,
		...
		script := "set -- " + strings.Join(quoted, " ") + "\n" +
			...
			ShellScriptQuote(AgentProtocolVersion) + "|lcmd-webshell-agent-v27|lcmd-webshell-agent-v26)\n" +
