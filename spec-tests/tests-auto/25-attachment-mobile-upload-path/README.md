...
规格：[REQ](../../../spec/webshell/25-attachment-mobile-upload-path/REQ.md) · [AC](../../../spec/webshell/25-attachment-mobile-upload-path/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/25-attachment-mobile-upload-path/SC-ATTACHMENT-MOBILE-UPLOAD-PATH --profile draft`（产品根目录）。
